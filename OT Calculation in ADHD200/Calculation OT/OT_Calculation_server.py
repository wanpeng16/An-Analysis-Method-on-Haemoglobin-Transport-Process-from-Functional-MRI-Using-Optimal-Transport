...
def GetOTM(path, name):
    ...
    odata = odata[:, :, :, :]
    stasMap = np.zeros(8468*8468)
    stasMap = stasMap.reshape(8468, 8468)
    for i in range(l-1):
...
Save as a result
'''
rootdir = "/home/guoxiaobo96/OT/part3"
